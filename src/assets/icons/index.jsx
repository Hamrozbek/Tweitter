...
function CommenIcon() {
    return (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <mask id="mask0_11229_250" style={{ "maskType": "alpha" }} maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
                <rect width="24" height="24" fill="currentColor" />
            </mask>
            <g mask="url(#mask0_11229_250)">
                <path d="M13.95 2.01L9.802 2H9.8C5.426 2 2 5.427 2 9.80201C2 13.9 5.186 17.008 9.465 17.172V21C9.465 21.108 9.509 21.286 9.585 21.403C9.727 21.628 9.96899 21.75 10.217 21.75C10.355 21.75 10.494 21.712 10.619 21.632C10.883 21.464 17.092 17.492 18.707 16.126C20.609 14.516 21.747 12.156 21.75 9.81401V9.79701C21.744 5.43 18.32 2.01 13.95 2.009V2.01ZM17.737 14.982C16.603 15.942 12.875 18.387 10.965 19.625V16.438C10.965 16.024 10.63 15.688 10.215 15.688H9.819C6.159 15.688 3.501 13.212 3.501 9.80201C3.501 6.268 6.269 3.5 9.801 3.5L13.948 3.51H13.95C17.482 3.51 20.25 6.276 20.252 9.80601C20.249 11.716 19.31 13.65 17.738 14.982H17.737Z" fill="currentColor" />
            </g>
        </svg>
    )
}
function RepostIcon() {
    return (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <mask id="mask0_11229_255" style={{ "maskType": "alpha" }} maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
                <rect width="24" height="24" fill="currentColor" />
            </mask>
            <g mask="url(#mask0_11229_255)">
...
function LikeIcon() {
    return (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <mask id="mask0_11229_260" style={{ "maskType": "alpha" }} maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
                <rect width="24" height="24" fill="currentColor" />
            </mask>
            <g mask="url(#mask0_11229_260)">
                <path d="M12.05 21.914H12.036C9.453 21.866 2 15.132 2 8.754C2 5.69 4.525 3 7.403 3C9.693 3 11.233 4.58 12.049 5.73C12.863 4.582 14.403 3 16.694 3C19.574 3 22.098 5.69 22.098 8.755C22.098 15.131 14.644 21.865 12.061 21.912H12.05V21.914ZM7.404 4.501C5.324 4.501 3.501 6.489 3.501 8.756C3.501 14.496 10.535 20.352 12.051 20.414C13.569 20.352 20.601 14.497 20.601 8.756C20.601 6.489 18.778 4.501 16.698 4.501C14.17 4.501 12.758 7.437 12.746 7.466C12.516 8.028 11.59 8.028 11.359 7.466C11.345 7.436 9.93401 4.501 7.40501 4.501H7.404Z" fill="currentColor" />
            </g>
        </svg>
...
function UploadIcon() {
    return (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <mask id="mask0_11229_264" style={{ "maskType": "alpha" }} maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
                <rect width="24" height="24" fill="currentColor" />
            </mask>
            <g mask="url(#mask0_11229_264)">
                <path d="M17.53 7.21975L12.53 2.21975C12.237 1.92675 11.762 1.92675 11.47 2.21975L6.47001 7.21975C6.17601 7.51275 6.17601 7.98775 6.47001 8.27975C6.76401 8.57175 7.23701 8.57375 7.53001 8.27975L11.25 4.55975V14.7498C11.25 15.1638 11.586 15.4998 12 15.4998C12.414 15.4998 12.75 15.1638 12.75 14.7498V4.55975L16.47 8.27975C16.616 8.42675 16.808 8.49975 17 8.49975C17.192 8.49975 17.384 8.42775 17.53 8.27975C17.823 7.98675 17.823 7.51275 17.53 7.21975Z" fill="currentColor" />
                <path d="M19.708 21.6938H4.29201C3.02801 21.6938 2 20.6658 2 19.4018V13.7498C2 13.3358 2.336 12.9998 2.75 12.9998C3.164 12.9998 3.5 13.3358 3.5 13.7498V19.4018C3.5 19.8388 3.85501 20.1938 4.29201 20.1938H19.708C20.145 20.1938 20.5 19.8388 20.5 19.4018V13.7498C20.5 13.3358 20.836 12.9998 21.25 12.9998C21.664 12.9998 22 13.3358 22 13.7498V19.4018C22 20.6658 20.972 21.6938 19.708 21.6938Z" fill="currentColor" />
            </g>
        </svg>
    )
}
function StatisticIcon() {
    return (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <mask id="mask0_11229_269" style={{ "maskType": "alpha" }} maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
                <rect width="24" height="24" fill="currentColor" />
            </mask>
            <g mask="url(#mask0_11229_269)">
...
function SearchIcon() {
    return (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <mask id="mask0_11_1470" style={{ "maskType": "alpha" }} maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
                <rect width="24" height="24" fill="currentColor" />
            </mask>
